    ...
    public partial class AddAllTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookDiscountHistory", x => x.DiscountHistoryId);
                    table.ForeignKey(
                        name: "FK_BookDiscountHistory_AspNetUsers_CreatedBy",
                        column: x => x.CreatedBy,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookDiscountHistory_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookDiscountHistory_BookId",
                table: "BookDiscountHistory",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookDiscountHistory_CreatedBy",
                table: "BookDiscountHistory",
                column: "CreatedBy");
