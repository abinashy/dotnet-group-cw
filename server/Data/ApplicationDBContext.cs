    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Book>().HasData(
            new Book
            {
                ...
                Price = 19.99m,
                ISBN = "9780000000001",
                PublicationDate = DateTime.SpecifyKind(new DateTime(2023, 6, 15, 0, 0, 0), DateTimeKind.Utc),
                PageCount = 250,
                Language = "English",
                Format = "Paperback",
            ...
            new Book
            {
                ...
                Price = 14.99m,
                ISBN = "9780000000002",
                PublicationDate = DateTime.SpecifyKind(new DateTime(2022, 9, 10, 0, 0, 0), DateTimeKind.Utc),
                PageCount = 180,
                Language = "English",
                Format = "Hardcover",
                IsAwardWinning = true,
            ...
            new Book
            {
                ...
                Price = 29.99m,
                ISBN = "9780000000003",
                PublicationDate = DateTime.SpecifyKind(new DateTime(2024, 3, 1, 0, 0, 0), DateTimeKind.Utc),
                PageCount = 320,
                Language = "English",
                Format = "eBook",
                IsAwardWinning = false,
